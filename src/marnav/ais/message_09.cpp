...
utils::optional<geo::longitude> message_09::get_longitude() const
{
...
utils::optional<geo::latitude> message_09::get_latitude() const
{
...
void message_09::set_longitude(const utils::optional<geo::longitude> & t)
{
	longitude_minutes = t
...
void message_09::set_latitude(const utils::optional<geo::latitude> & t)
{
	latitude_minutes = t
